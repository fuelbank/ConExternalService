...
--the package (inital base) has how to use dummy id/password for UI login cdsrc.json
-- in tutorial, we accesses api hub api, and exposed them in fiori preview  with authentication
